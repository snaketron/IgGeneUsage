---
title: "Model Comparison (Data: IGHV HIV)"
author: "SK"
date: "June 25, 2019"
output:
  BiocStyle::html_document
vignette: >
  %\VignetteIndexEntry{Model Comparison (Data: IGHV HIV)}
...
```{r}
B <- get(load(file = "R/dev/ighv_hiv_binomial.RData"))
BB <- get(load(file = "R/dev/ighv_hiv_beta_binomial_model.RData"))
ZIBB <- get(load(file = "R/dev/ighv_hiv_zibb_model.RData"))
rm(M)
```
