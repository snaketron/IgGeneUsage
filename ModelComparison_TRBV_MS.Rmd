---
title: "Model Comparison (TRBV MS)"
author: "SK"
date: "June 25, 2019"
output: 
  html_document: 
...
```{r}
M0 <- get(load(file = "R/dev/trbv_MS_zero_model.RData"))
M1 <- get(load(file = "R/dev/trbv_MS_model.RData"))
M2 <- get(load(file = "R/dev/trbv_MS_zib_multiz.RData"))
M3 <- get(load(file = "R/dev/trbv_MS_beta_binomial_model.RData"))
rm(usage.hiv.csm)
