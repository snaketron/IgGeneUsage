---
title: "Model Comparison (Data: IGHV HCV)"
author: "SK"
date: "June 25, 2019"
output:
  BiocStyle::html_document
vignette: >
  %\VignetteIndexEntry{Model Comparison (Data: IGHV HCV)}
...
```{r}
B <- get(load(file = "R/dev/ighv_hcv_binomial.RData"))
BB <- get(load(file = "R/dev/ighv_hcv_beta_binomial_model.RData"))
ZIBB <- get(load(file = "R/dev/ighv_hcv_zibb_model.RData"))
rm(M)
```
...
# interesting genes
interesting.hits <- effect.comparsion$gene_name[effect.comparsion$rank.zibb.bb <= 5 | 
                                                   effect.comparsion$rank.zibb.b <= 5 | 
                                                   effect.comparsion$rank.bb.b <= 5]
interesting.hits <- unique(interesting.hits)
