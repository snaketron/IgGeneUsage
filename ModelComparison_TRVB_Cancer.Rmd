---
title: "Model Comparison (TRVB Cancer)"
author: "SK"
date: "June 25, 2019"
output: 
  html_document: 
...
```{r}
M0 <- get(load(file = "R/dev/trv_cancer_zero_model.RData"))
M1 <- get(load(file = "R/dev/trv_cancer_model.RData"))
M2 <- get(load(file = "R/dev/trv_cancer_zib_multiz.RData"))
M3 <- get(load(file = "R/dev/trv_cancer_beta_binomial_model.RData"))
rm(usage.hiv.csm)
