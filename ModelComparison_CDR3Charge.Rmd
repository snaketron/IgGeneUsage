---
title: "Model Comparison (CDR3 Net Charge)"
author: "SK"
date: "June 25, 2019"
output: 
  html_document: 
...
```{r}
B <- get(load(file = "R/dev/epitopes_binomial.RData"))
BB <- get(load(file = "R/dev/epitopes_beta_binomial_model.RData"))
ZIBB <- get(load(file = "R/dev/epitopes_zibb_model.RData"))
rm(M)
```
...
## Prediction of overal gene (net charge) usage [%]
  * Error bars represent 95\% HDI
