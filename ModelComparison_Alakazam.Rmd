...
M4 <- get(load(file = "R/dev/alakazam_ighv_families_zibb_model.RData"))
M5 <- get(load(file = "R/dev/alakazam_ighv_families_zmix_model.RData"))
...
grid.arrange(
  ...
  ggplot()+
    ...
    geom_sina(data = M3$ppc, aes(x = "M3", y = abs(raw-ppc.raw.mean)),
              shape = 21, fill = "white")+
    geom_sina(data = M3$ppc, aes(x = "M4", y = abs(raw-ppc.raw.mean)),
              shape = 21, fill = "white")+
    geom_sina(data = M3$ppc, aes(x = "M5", y = abs(raw-ppc.raw.mean)),
              shape = 21, fill = "white")+
    theme_bw(base_size = 9)+
    theme(legend.position = "top")+
