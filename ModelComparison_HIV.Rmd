...
```{r}
M0 <- get(load(file = "R/dev/ighv_hiv_zero_model.RData"))
M1 <- get(load(file = "R/dev/ighv_hiv_model.RData"))
M2 <- get(load(file = "R/dev/ighv_hiv_zib_multiz.RData"))
M3 <- get(load(file = "R/dev/ighv_hiv_beta_binomial_model.RData"))
rm(usage.hiv.csm)
