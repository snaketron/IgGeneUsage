...
#include "stanExports_zibb_original.h"

RCPP_MODULE(stan_fit4zibb_original_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_zibb_original")
