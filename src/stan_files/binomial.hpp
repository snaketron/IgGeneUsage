...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(86, 84, "end", "model_binomial");
    return reader;
}
...
public:
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            validate_non_negative_index("mu", "N_gene", N_gene);
            validate_non_negative_index("mu", "N_sample", N_sample);
            std::vector<Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> > mu(N_sample, Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1>(N_gene));
            ...
            for (int i = 1; i <= N_sample; ++i) {
                ...
                stan::model::assign(mu, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            add(alpha_gene, multiply(get_base1(beta, i, "beta", 1), get_base1(X, i, "X", 1))), 
            ...
            current_statement_begin__ = 30;
            size_t mu_k_0_max__ = N_sample;
            size_t mu_j_1_max__ = N_gene;
            ...
            for (int i = 1; i <= N_sample; ++i) {
                ...
                lp_accum__.add(binomial_logit_log<propto__>(stan::model::rvalue(Y, stan::model::cons_list(stan::model::index_omni(), stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list())), "Y"), get_base1(N, i, "N", 1), get_base1(mu, i, "mu", 1)));
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        try {
            ...
            validate_non_negative_index("mu", "N_gene", N_gene);
            validate_non_negative_index("mu", "N_sample", N_sample);
            std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > mu(N_sample, Eigen::Matrix<double, Eigen::Dynamic, 1>(N_gene));
            stan::math::initialize(mu, DUMMY_VAR__);
            stan::math::fill(mu, DUMMY_VAR__);
            ...
            for (int j = 1; j <= N_gene; ++j) {
                ...
                for (int i = 1; i <= N_sample; ++i) {
                    ...
                    stan::model::assign(log_lik, 
                                ...
                                binomial_logit_log(get_base1(get_base1(Y, j, "Y", 1), i, "Y", 2), get_base1(N, i, "N", 1), (get_base1(alpha_gene, j, "alpha_gene", 1) + (get_base1(get_base1(beta, i, "beta", 1), j, "beta", 2) * get_base1(X, i, "X", 1)))), 
                                "assigning variable log_lik");
                    current_statement_begin__ = 72;
                    stan::model::assign(Yhat, 
                                stan::model::cons_list(stan::model::index_uni(j), stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list())), 
                                binomial_rng(get_base1(N, i, "N", 1), inv_logit((get_base1(alpha_gene, j, "alpha_gene", 1) + (get_base1(get_base1(beta, i, "beta", 1), j, "beta", 2) * get_base1(X, i, "X", 1)))), base_rng__), 
...
typedef model_binomial_namespace::model_binomial stan_model;
