...
namespace model_zibb_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_zibb_model");
    reader.add_event(137, 135, "end", "model_zibb_model");
    return reader;
}
...
#include <meta_header.hpp>
 class model_zibb_model : public prob_grad {
private:
        int N_sample;
        int N_gene;
...
public:
    model_zibb_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_zibb_model_namespace::model_zibb_model";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(beta_log<propto__>(z, 1, 3));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_zibb_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_zibb_model_namespace::model_zibb_model stan_model;
