...
namespace model_beta_binomial_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_beta_binomial_model");
    reader.add_event(95, 93, "end", "model_beta_binomial_model");
    return reader;
}

#include <meta_header.hpp>
 class model_beta_binomial_model : public prob_grad {
private:
        int N_sample;
        int N_gene;
...
public:
    model_beta_binomial_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_beta_binomial_model_namespace::model_beta_binomial_model";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= N_sample; ++i) {
                ...
                lp_accum__.add(beta_binomial_log<propto__>(stan::model::rvalue(Y, stan::model::cons_list(stan::model::index_omni(), stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list())), "Y"), get_base1(N, i, "N", 1), get_base1(a, i, "a", 1), get_base1(b, i, "b", 1)));
            }
            current_statement_begin__ = 52;
            lp_accum__.add(normal_log<propto__>(alpha_grand, 0, 10));
            current_statement_begin__ = 53;
            lp_accum__.add(normal_log<propto__>(beta_grand, 0, 5));
            ...
            for (int i = 1; i <= N_sample; ++i) {
                ...
                lp_accum__.add(normal_log<propto__>(get_base1(beta_raw, i, "beta_raw", 1), 0, 1));
            }
            current_statement_begin__ = 63;
            lp_accum__.add(normal_log<propto__>(beta_gene_raw, 0, 1));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_beta_binomial_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> log_lik(N_gene, N_sample);
            ...
            for (int j = 1; j <= N_gene; ++j) {
                ...
                for (int i = 1; i <= N_sample; ++i) {
                    ...
                    stan::model::assign(log_lik, 
                                ...
                                beta_binomial_log(get_base1(get_base1(Y, j, "Y", 1), i, "Y", 2), get_base1(N, i, "N", 1), get_base1(get_base1(a, i, "a", 1), j, "a", 2), get_base1(get_base1(b, i, "b", 1), j, "b", 2)), 
                                "assigning variable log_lik");
                    current_statement_begin__ = 80;
                    stan::model::assign(Yhat, 
                                stan::model::cons_list(stan::model::index_uni(j), stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list())), 
                                beta_binomial_rng(get_base1(N, i, "N", 1), get_base1(get_base1(a, i, "a", 1), j, "a", 2), get_base1(get_base1(b, i, "b", 1), j, "b", 2), base_rng__), 
                    ...
                    if (as_bool(logical_eq(get_base1(Nreal, i, "Nreal", 1), 0.0))) {
                        ...
                        stan::model::assign(Yhat_individual, 
                                    stan::model::cons_list(stan::model::index_uni(j), stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list())), 
                                    ((get_base1(get_base1(Yhat, j, "Yhat", 1), i, "Yhat", 2) / get_base1(Nreal, i, "Nreal", 1)) * 100.0), 
                                    "assigning variable Yhat_individual");
                    }
                }
                ...
                stan::model::assign(Yhat_gene, 
                            ...
                            (inv_logit((get_base1(alpha_gene, j, "alpha_gene", 1) + (get_base1(beta_gene, j, "beta_gene", 1) * 1.0))) * 100.0), 
            ...
            current_statement_begin__ = 74;
            size_t log_lik_j_2_max__ = N_sample;
    ...
    static std::string model_name() {
        return "model_beta_binomial_model";
    }
...
typedef model_beta_binomial_model_namespace::model_beta_binomial_model stan_model;
