...
#include "beta_binomial_model.hpp"

RCPP_MODULE(stan_fit4beta_binomial_model_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_beta_binomial_model")
