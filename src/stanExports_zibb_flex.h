...
namespace model_zibb_flex_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_zibb_flex");
    reader.add_event(144, 142, "end", "model_zibb_flex");
    return reader;
}
...
class model_zibb_flex
  : public stan::model::model_base_crtp<model_zibb_flex> {
private:
        int N_sample;
        int N_gene;
...
public:
    model_zibb_flex(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_zibb_flex_namespace::model_zibb_flex";
        ...
        try {
            ...
            validate_non_negative_index("alpha_raw", "N_sample", N_sample);
            ...
            validate_non_negative_index("alpha_gene_raw", "N_gene", N_gene);
            ...
            validate_non_negative_index("z", "N_gene", N_gene);
            num_params_r__ += N_gene;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 43;
        if (!(context__.contains_r("alpha_gene_sigma")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable alpha_gene_sigma missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("alpha_gene_sigma");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "alpha_gene_sigma", "double", context__.to_vec());
        double alpha_gene_sigma(0);
        alpha_gene_sigma = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, alpha_gene_sigma);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable alpha_gene_sigma: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 44;
        ...
        validate_non_negative_index("alpha_raw", "N_gene", N_gene);
        validate_non_negative_index("alpha_raw", "N_sample", N_sample);
        context__.validate_dims("parameter initialization", "alpha_raw", "vector_d", context__.to_vec(N_sample,N_gene));
        std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > alpha_raw(N_sample, Eigen::Matrix<double, Eigen::Dynamic, 1>(N_gene));
        size_t alpha_raw_j_1_max__ = N_gene;
        size_t alpha_raw_k_0_max__ = N_sample;
        for (size_t j_1__ = 0; j_1__ < alpha_raw_j_1_max__; ++j_1__) {
            for (size_t k_0__ = 0; k_0__ < alpha_raw_k_0_max__; ++k_0__) {
                alpha_raw[k_0__](j_1__) = vals_r__[pos__++];
            }
        }
        size_t alpha_raw_i_0_max__ = N_sample;
        for (size_t i_0__ = 0; i_0__ < alpha_raw_i_0_max__; ++i_0__) {
            try {
                writer__.vector_unconstrain(alpha_raw[i_0__]);
            } catch (const std::exception& e) {
        ...
        current_statement_begin__ = 47;
        if (!(context__.contains_r("alpha_gene_raw")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable alpha_gene_raw missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("alpha_gene_raw");
        pos__ = 0U;
        validate_non_negative_index("alpha_gene_raw", "N_gene", N_gene);
        context__.validate_dims("parameter initialization", "alpha_gene_raw", "vector_d", context__.to_vec(N_gene));
        Eigen::Matrix<double, Eigen::Dynamic, 1> alpha_gene_raw(N_gene);
        size_t alpha_gene_raw_j_1_max__ = N_gene;
        for (size_t j_1__ = 0; j_1__ < alpha_gene_raw_j_1_max__; ++j_1__) {
            alpha_gene_raw(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_unconstrain(alpha_gene_raw);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable alpha_gene_raw: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 48;
        ...
        pos__ = 0U;
        validate_non_negative_index("z", "N_gene", N_gene);
        context__.validate_dims("parameter initialization", "z", "vector_d", context__.to_vec(N_gene));
        Eigen::Matrix<double, Eigen::Dynamic, 1> z(N_gene);
        size_t z_j_1_max__ = N_gene;
        for (size_t j_1__ = 0; j_1__ < z_j_1_max__; ++j_1__) {
            z(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_lub_unconstrain(0, 1, z);
        } catch (const std::exception& e) {
        ...
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "z_mu", "double", context__.to_vec());
        double z_mu(0);
        z_mu = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, z_mu);
        } catch (const std::exception& e) {
        ...
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "z_phi", "double", context__.to_vec());
        double z_phi(0);
        z_phi = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, z_phi);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 43;
            local_scalar_t__ alpha_gene_sigma;
            (void) alpha_gene_sigma;  // dummy to suppress unused var warning
            if (jacobian__)
                alpha_gene_sigma = in__.scalar_lb_constrain(0, lp__);
            else
                alpha_gene_sigma = in__.scalar_lb_constrain(0);
            current_statement_begin__ = 44;
            ...
            current_statement_begin__ = 45;
            std::vector<Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> > alpha_raw;
            size_t alpha_raw_d_0_max__ = N_sample;
            alpha_raw.reserve(alpha_raw_d_0_max__);
            for (size_t d_0__ = 0; d_0__ < alpha_raw_d_0_max__; ++d_0__) {
                if (jacobian__)
                    alpha_raw.push_back(in__.vector_constrain(N_gene, lp__));
                else
                    alpha_raw.push_back(in__.vector_constrain(N_gene));
            }
            current_statement_begin__ = 46;
            ...
            current_statement_begin__ = 47;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> alpha_gene_raw;
            (void) alpha_gene_raw;  // dummy to suppress unused var warning
            if (jacobian__)
                alpha_gene_raw = in__.vector_constrain(N_gene, lp__);
            else
                alpha_gene_raw = in__.vector_constrain(N_gene);
            current_statement_begin__ = 48;
            ...
            if (jacobian__)
                z = in__.vector_lub_constrain(0, 1, N_gene, lp__);
            else
                z = in__.vector_lub_constrain(0, 1, N_gene);
            current_statement_begin__ = 53;
            local_scalar_t__ z_mu;
            (void) z_mu;  // dummy to suppress unused var warning
            if (jacobian__)
                z_mu = in__.scalar_lb_constrain(0, lp__);
            else
                z_mu = in__.scalar_lb_constrain(0);
            current_statement_begin__ = 54;
            local_scalar_t__ z_phi;
            (void) z_phi;  // dummy to suppress unused var warning
            if (jacobian__)
                z_phi = in__.scalar_lb_constrain(0, lp__);
            else
                z_phi = in__.scalar_lb_constrain(0);
            // transformed parameters
            current_statement_begin__ = 60;
            validate_non_negative_index("alpha", "N_gene", N_gene);
            validate_non_negative_index("alpha", "N_sample", N_sample);
            std::vector<Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> > alpha(N_sample, Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1>(N_gene));
            ...
            stan::math::assign(alpha_gene, add(0, multiply(alpha_gene_sigma, alpha_gene_raw)));
            current_statement_begin__ = 69;
            stan::math::assign(beta_gene, add(0, multiply(beta_gene_sigma, beta_gene_raw)));
            ...
            for (int i = 1; i <= N_sample; ++i) {
                ...
                stan::model::assign(alpha, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            add(alpha_gene, multiply(alpha_sigma, get_base1(alpha_raw, i, "alpha_raw", 1))), 
                            "assigning variable alpha");
                current_statement_begin__ = 75;
                stan::model::assign(a, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            multiply(inv_logit(add(get_base1(alpha, i, "alpha", 1), multiply(get_base1(beta, i, "beta", 1), get_base1(X, i, "X", 1)))), phi), 
            ...
            (void) function__;  // dummy to suppress unused var warning
            current_statement_begin__ = 60;
            size_t alpha_k_0_max__ = N_sample;
            size_t alpha_j_1_max__ = N_gene;
            for (size_t k_0__ = 0; k_0__ < alpha_k_0_max__; ++k_0__) {
                for (size_t j_1__ = 0; j_1__ < alpha_j_1_max__; ++j_1__) {
                    if (stan::math::is_uninitialized(alpha[k_0__](j_1__))) {
                        std::stringstream msg__;
                        msg__ << "Undefined transformed parameter: alpha" << "[" << k_0__ << "]" << "(" << j_1__ << ")";
            ...
            for (int i = 1; i <= N_sample; ++i) {
                ...
                for (int j = 1; j <= N_gene; ++j) {
                    ...
                    lp_accum__.add(zibb_lpmf(get_base1(get_base1(Y, j, "Y", 1), i, "Y", 2), get_base1(N, i, "N", 1), get_base1(get_base1(a, i, "a", 1), j, "a", 2), get_base1(get_base1(b, i, "b", 1), j, "b", 2), get_base1(z, j, "z", 1), pstream__));
                }
            }
            current_statement_begin__ = 90;
            lp_accum__.add(cauchy_log<propto__>(alpha_sigma, 0, 1));
            current_statement_begin__ = 91;
            lp_accum__.add(cauchy_log<propto__>(beta_sigma, 0, 1));
            current_statement_begin__ = 93;
            lp_accum__.add(cauchy_log<propto__>(alpha_gene_sigma, 0, 1));
            current_statement_begin__ = 94;
            lp_accum__.add(cauchy_log<propto__>(beta_gene_sigma, 0, 1));
            current_statement_begin__ = 96;
            for (int i = 1; i <= N_sample; ++i) {
                current_statement_begin__ = 97;
                lp_accum__.add(std_normal_log<propto__>(get_base1(alpha_raw, i, "alpha_raw", 1)));
                current_statement_begin__ = 98;
                lp_accum__.add(std_normal_log<propto__>(get_base1(beta_raw, i, "beta_raw", 1)));
            }
            current_statement_begin__ = 100;
            lp_accum__.add(std_normal_log<propto__>(alpha_gene_raw));
            current_statement_begin__ = 101;
            lp_accum__.add(std_normal_log<propto__>(beta_gene_raw));
            current_statement_begin__ = 103;
            lp_accum__.add(exponential_log<propto__>(phi, tau));
            current_statement_begin__ = 104;
            lp_accum__.add(gamma_log<propto__>(tau, 3, 0.1));
            current_statement_begin__ = 107;
            lp_accum__.add(beta_log<propto__>(z, (z_phi * z_mu), (z_phi * (1 - z_mu))));
            current_statement_begin__ = 108;
            lp_accum__.add(beta_log<propto__>(z_mu, 1.0, 3.0));
            current_statement_begin__ = 109;
            lp_accum__.add(exponential_log<propto__>(z_phi, 0.1));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_zibb_flex_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        double alpha_gene_sigma = in__.scalar_lb_constrain(0);
        vars__.push_back(alpha_gene_sigma);
        double beta_gene_sigma = in__.scalar_lb_constrain(0);
        vars__.push_back(beta_gene_sigma);
        std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > alpha_raw;
        size_t alpha_raw_d_0_max__ = N_sample;
        alpha_raw.reserve(alpha_raw_d_0_max__);
        for (size_t d_0__ = 0; d_0__ < alpha_raw_d_0_max__; ++d_0__) {
            alpha_raw.push_back(in__.vector_constrain(N_gene));
        ...
        for (size_t j_1__ = 0; j_1__ < alpha_raw_j_1_max__; ++j_1__) {
            for (size_t k_0__ = 0; k_0__ < alpha_raw_k_0_max__; ++k_0__) {
                vars__.push_back(alpha_raw[k_0__](j_1__));
            }
        }
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> alpha_gene_raw = in__.vector_constrain(N_gene);
        size_t alpha_gene_raw_j_1_max__ = N_gene;
        for (size_t j_1__ = 0; j_1__ < alpha_gene_raw_j_1_max__; ++j_1__) {
            vars__.push_back(alpha_gene_raw(j_1__));
        }
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> z = in__.vector_lub_constrain(0, 1, N_gene);
        size_t z_j_1_max__ = N_gene;
        for (size_t j_1__ = 0; j_1__ < z_j_1_max__; ++j_1__) {
            vars__.push_back(z(j_1__));
        }
        double z_mu = in__.scalar_lb_constrain(0);
        vars__.push_back(z_mu);
        double z_phi = in__.scalar_lb_constrain(0);
        ...
        try {
            ...
            validate_non_negative_index("alpha", "N_gene", N_gene);
            validate_non_negative_index("alpha", "N_sample", N_sample);
            std::vector<Eigen::Matrix<double, Eigen::Dynamic, 1> > alpha(N_sample, Eigen::Matrix<double, Eigen::Dynamic, 1>(N_gene));
            stan::math::initialize(alpha, DUMMY_VAR__);
            stan::math::fill(alpha, DUMMY_VAR__);
            current_statement_begin__ = 61;
            validate_non_negative_index("beta", "N_gene", N_gene);
            ...
            std::vector<std::vector<int> > Yhat(N_gene, std::vector<int>(N_sample, int(0)));
            ...
            for (int j = 1; j <= N_gene; ++j) {
                ...
                for (int i = 1; i <= N_sample; ++i) {
                    ...
                    stan::model::assign(log_lik, 
                                ...
                                zibb_lpmf(get_base1(get_base1(Y, j, "Y", 1), i, "Y", 2), get_base1(N, i, "N", 1), get_base1(get_base1(a, i, "a", 1), j, "a", 2), get_base1(get_base1(b, i, "b", 1), j, "b", 2), get_base1(z, j, "z", 1), pstream__), 
                    ...
                    stan::model::assign(Yhat, 
                                ...
                                zibb_rng(get_base1(get_base1(Y, j, "Y", 1), i, "Y", 2), get_base1(N, i, "N", 1), get_base1(get_base1(a, i, "a", 1), j, "a", 2), get_base1(get_base1(b, i, "b", 1), j, "b", 2), get_base1(z, j, "z", 1), base_rng__, pstream__), 
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "alpha_gene_sigma";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        ...
        for (size_t j_1__ = 0; j_1__ < alpha_raw_j_1_max__; ++j_1__) {
            for (size_t k_0__ = 0; k_0__ < alpha_raw_k_0_max__; ++k_0__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "alpha_raw" << '.' << k_0__ + 1 << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
        }
        size_t beta_raw_j_1_max__ = N_gene;
        ...
        for (size_t j_1__ = 0; j_1__ < alpha_gene_raw_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "alpha_gene_raw" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        size_t beta_gene_raw_j_1_max__ = N_gene;
        for (size_t j_1__ = 0; j_1__ < beta_gene_raw_j_1_max__; ++j_1__) {
...
typedef model_zibb_flex_namespace::model_zibb_flex stan_model;
#ifndef USING_R
