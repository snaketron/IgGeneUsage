...
Lets analyze the differential gene usage in the data Ig.
...
The effect size and $\pi$ are related. Lets visualize them for each gene (shown 
as a point). There are no genes with $\pi \approx 1$ $\rightarrow$ no evidence
of differential gene usage based on IgGeneUsage. 
